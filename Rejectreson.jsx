...
function  Rejectreson(){
    return(
        <div className="Rejectreson">
            ...
            <div className=" TTextboxr"><input type="text" id="text"  /></div>
            ...
            <div className="Dater"><input type="date"/></div>
            <div className="Languager"><a><BsDot /></a><p>LANGUAGE</p></div>
            <div className=" LTextboxr"><input type="text" id="text" /></div>
            <div className="Descraptionr"><a><BsDot /></a><p>DESCRAPTION</p></div>
            <div className=" DTextboxr"><textarea rows="4"></textarea></div>
            <div className="Genresr"><a><BsDot /></a><p>Genres (comma separated)</p></div>
            <div className=" GTextboxr"><input type="text" id="text" /></div>
